...
architecture behav of bd_19ea_csc_0_AXIvideo2MultiPixStream_Pipeline_loop_width is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln545_reg_353 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal j_fu_96 : STD_LOGIC_VECTOR (10 downto 0) := "00000000000";
    signal j_4_fu_223_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_sig_allocacmp_j_3 : STD_LOGIC_VECTOR (10 downto 0);
    signal axi_data_fu_100 : STD_LOGIC_VECTOR (23 downto 0) := "000000000000000000000000";
    signal axi_last_fu_104 : STD_LOGIC_VECTOR (0 downto 0) := "0";
    signal or_ln587_3_fu_309_p4 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal stream_in_write_local : STD_LOGIC;
    signal tmp_s_fu_264_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln63_fu_274_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_1_fu_285_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln574_2_fu_302_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln574_1_fu_295_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln574_fu_278_p3 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln545_reg_353 <= icmp_ln545_fu_217_p2;
            end if;
        end if;
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(stream_in_full_n, icmp_ln545_reg_353)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((icmp_ln545_reg_353 = ap_const_lv1_0) and (stream_in_full_n = ap_const_logic_0));
    end process;


    ap_condition_275_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln545_reg_353, ap_block_pp0_stage0)
    begin
                ap_condition_275 <= ((icmp_ln545_reg_353 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_condition_278_assign_proc : process(icmp_ln545_fu_217_p2, or_ln549_fu_229_p2, ap_start_int)
    begin
                ap_condition_278 <= ((or_ln549_fu_229_p2 = ap_const_lv1_0) and (icmp_ln545_fu_217_p2 = ap_const_lv1_0) and (ap_start_int = ap_const_logic_1));
    end process;


    ap_condition_283_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln545_reg_353, ap_block_pp0_stage0_11001)
    begin
                ap_condition_283 <= ((icmp_ln545_reg_353 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    ap_phi_mux_eol_phi_fu_180_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, eol_reg_177, ap_loop_init, axi_last_fu_104, ap_condition_275)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) then
    ...
    ap_phi_mux_sof_phi_fu_191_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, sof_4, ap_loop_init, ap_condition_275)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) then
            if ((ap_const_boolean_1 = ap_condition_275)) then 
    ...
    axi_data_14_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln545_fu_217_p2, ap_loop_exit_ready, ap_block_pp0_stage0_11001)
    begin
        if (((ap_loop_exit_ready = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln545_fu_217_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    eol_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln545_fu_217_p2, ap_loop_exit_ready, ap_block_pp0_stage0_11001)
    begin
        if (((ap_loop_exit_ready = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln545_fu_217_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    or_ln587_3_fu_309_p4 <= ((select_ln574_2_fu_302_p3 & select_ln574_1_fu_295_p3) & select_ln574_fu_278_p3);
    ...
    select_ln574_1_fu_295_p3 <= 
        trunc_ln63_fu_274_p1 when (cond(0) = '1') else 
        tmp_1_fu_285_p4;
    select_ln574_2_fu_302_p3 <= 
        tmp_1_fu_285_p4 when (cond(0) = '1') else 
        tmp_s_fu_264_p4;
    select_ln574_fu_278_p3 <= 
        tmp_s_fu_264_p4 when (cond(0) = '1') else 
        trunc_ln63_fu_274_p1;

    stream_in_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, stream_in_full_n, icmp_ln545_reg_353, ap_block_pp0_stage0)
    begin
        if (((icmp_ln545_reg_353 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    stream_in_din <= or_ln587_3_fu_309_p4;
    stream_in_write <= stream_in_write_local;

    stream_in_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln545_reg_353, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln545_reg_353 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    trunc_ln63_fu_274_p1 <= axi_data_fu_100(8 - 1 downto 0);
end behav;

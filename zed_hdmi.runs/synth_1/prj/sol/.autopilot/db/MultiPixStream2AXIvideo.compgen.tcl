...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthOut_dout { I 11 vector } WidthOut_num_data_valid { I 3 vector } WidthOut_fifo_cap { I 3 vector } WidthOut_empty_n { I 1 bit } WidthOut_read { O 1 bit } } \
} "
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bd_19ea_csc_0_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}

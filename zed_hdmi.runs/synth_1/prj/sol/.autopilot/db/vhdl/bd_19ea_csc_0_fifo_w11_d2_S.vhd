...
architecture rtl of bd_19ea_csc_0_fifo_w11_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component bd_19ea_csc_0_fifo_w11_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 11;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_bd_19ea_csc_0_fifo_w11_d2_S_ShiftReg : bd_19ea_csc_0_fifo_w11_d2_S_ShiftReg
    generic map (
...
architecture rtl of bd_19ea_csc_0_fifo_w11_d2_S_ShiftReg is

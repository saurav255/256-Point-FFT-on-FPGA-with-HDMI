...
#
# Script generated by Vivado on Sat Sep 06 23:23:28 +0530 2025
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/bd_19ea.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
